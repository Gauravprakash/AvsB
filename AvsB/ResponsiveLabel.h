 ...
 */
typedef void (^PatternTapResponder)(NSString *tappedString, NSInteger tag);
 ...
 */
@protocol ResposiveProtocol <NSObject>
-(void)labelTappedwithTag:(NSInteger )tag;
@end
...
#endif
@property(nonatomic,strong)id<ResposiveProtocol>responsiveDelegate;
